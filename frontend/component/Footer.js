    ...
    return (
        <div className="footer-container flex flex-row justify-between items-center bg-gray-200 w-full shadow-md p-4">
            ...
            <div className="social-container flex flex-row">
                <img className="w-10 h-10 m-2" src={adminPath ? `../../icon/facebook.png` : `icon/facebook.png`} alt="facebook icon" />
                <img className="w-10 h-10 m-2" src={adminPath ? `../../icon/line.png` : `icon/line.png`} alt="line icon" />
            </div>
        </div>
    )
}
