    ...
    return (
        <div className="min-h-screen flex flex-col items-center">
            ...
            <div className="repair flex flex-row flex-wrap p-10">
                <Card>
                    <img className="h-10 w-10 self-center" src="icon/booking.svg" alt="book" />
                ...
                <Card>
                    <img className="h-10 w-10 self-center" src="icon/settings.svg" alt="repair" />
                ...
                <Card>
                    <img className="h-10 w-10 self-center" src="icon/mobile-payment.svg" alt="repair" />
